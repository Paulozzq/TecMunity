    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('usuarios.update', $usuario->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="status" class="form-control" value="{{ $usuario->status }}">
            </div>
            <div class="form-group">
                <label for="privado">Privado</label>
                <input type="text" name="privado" class="form-control" value="{{ $usuario->privado }}">
            </div>
            <div class="form-group">
                <label for="admin">Admin</label>
                <input type="text" name="admin" class="form-control" value="{{ $usuario->admin }}">
            </div>
